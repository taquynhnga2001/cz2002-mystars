...
//     public static ArrayList readAdmins(String filePath) throws IOException {
...
//         String filename = "database/Admin.csv";
//         try {
//             // read file containing Professor records.
//             ArrayList al = TextDB.readAdmins(filename);
//             for (int i = 0; i < al.size(); i++) {
//                 Professor prof = (Professor) al.get(i);
