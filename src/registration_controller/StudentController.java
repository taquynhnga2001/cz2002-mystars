package src.registration_controller;
...
/**
 * Handle commands received from StudentView
 * 
 * @author Ta Quynh Nga
 */
public class StudentController {
     ...
     * @return CourseIndex
     * @throws WrongCourseIndex
     * @throws IOException
     * @throws DidntEnrollOrWait
     */
    ...
    /** 
     * Change the course index of a student
     * @param student
     * @param currentIndexStr
     * @param newIndexStr
     * @throws WrongCourseIndex
     * @throws NotSameCourse
     * @throws NoVacancy
     * @throws DidntEnrollOrWait
     * @throws ClashTime
     * @throws IOException
     * @throws AlreadyEnrolled
     */
    ...
    /** 
     * Swop course index from student1 to student 2
     * @param student1
     * @param student2
     * @param index1
     * @param index2
    ...
    /** 
     * Check if time1 clashes with time2 (in hour)
     * @param time1
     * @param time2
     * @return boolean
     */
