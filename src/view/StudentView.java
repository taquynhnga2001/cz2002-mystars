...
import src.authentication.PasswordField;
import src.custom_exceptions.*;
import src.entity.*;
import src.text_manager.*;
import src.registration_controller.*;


/**
 * Display the view to student
 * @author Ta Quynh Nga
 */
public class StudentView {
    ...
    /**Change course index to another index of an enrolled course */
    ...
    /**Swop the course index of the same course between 2 students */
    ...
    /**Course Planner Generator to find the combinations of not clashing indexes available */
